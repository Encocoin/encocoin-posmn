...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zxnkspends need to use the cs_spendcache
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 XNK at the same time
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzxnkAuto) const;
    ...
    */
    ...
    CzXNKWallet* getZWallet() { return zwalletMain; }
