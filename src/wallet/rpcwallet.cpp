...
UniValue listmintedzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->zxnkTracker->ListMints(true, fMatureOnly, true);
...
UniValue listzerocoinamounts(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    std::set<CMintMeta> setMints = pwalletMain->zxnkTracker->ListMints(true, true, true);
...
UniValue resetspentzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CzXNKTracker* zxnkTracker = pwalletMain->zxnkTracker.get();
    std::set<CMintMeta> setMints = zxnkTracker->ListMints(false, false, false);
...
UniValue exportzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CzXNKTracker* zxnkTracker = pwalletMain->zxnkTracker.get();
    std::set<CMintMeta> setMints = zxnkTracker->ListMints(!fIncludeSpent, false, false);
