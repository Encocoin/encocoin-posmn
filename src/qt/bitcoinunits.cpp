...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XNK);
    unitlist.append(mXNK);
    unitlist.append(uXNK);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case XNK:
        return QString("encocoin");
    case mXNK:
        return QString("mencocoin");
    case uXNK:
        return QString::fromUtf8("uencocoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XNK:
            return QString("tXNK");
        case mXNK:
            return QString("mtXNK");
        case uXNK:
            return QString::fromUtf8("μtXNK");
        default:
            return QString("???");
        }
    }
