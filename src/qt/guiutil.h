...
/** Utility functions used by the Encocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Encocoin addresses in monospace font
...
// Parse "encocoin:" URI into recipient object, return true on successful parsing
