...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XNK);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeEncocoinAmount"))
        SoftSetArg("-anonymizeencocoinamount", settings.value("nAnonymizeEncocoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in encocoin.cpp during shotdown to also remove the window positions
