...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Encocoin Core"),
     ...
     * override -datadir in the encocoin.conf file in the default data directory
     * (to be consistent with encocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
