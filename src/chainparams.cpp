...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (65594, uint256("d6c379fb14a83f1873a3f2965cd15e6e53c8c7d48e6174c425d563b629228bbd"))
    ;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1571525423, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("045943608c7b5b670ec27f705bee49ae7cc81d3a25b780b1d462a3e43a266d5247234106594b7e88e138e26f0234696613708246ea2db4dbaef1d8fd0d76d3cca1");
        nDefaultPort = 12044;
         ...
         *     CTxIn(COutPoint(000000, -1), coinbase )
         *     CTxOut(nValue=50.00000000, scriptPubKey=0xA9037BAC7050C479B121CF)
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Financial instruments issuance and processing on blockchain";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1566914714;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21745615;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c9e60965602f9f52ab9b2c46fc29143c05cd97f6e34bbb5185f882c303a"));
        assert(genesis.hashMerkleRoot == uint256("0xfc9b31d673dc1c9cc8ab6b16eef0150d609a52923c59fad394afd98809762b41"));

        vSeeds.push_back(CDNSSeedData("144.202.14.77", "144.202.14.77"));
        vSeeds.push_back(CDNSSeedData("140.82.13.75", "140.82.13.75"));
        ...
        strSporkKey = "04079fc366e62ac7f7d21e4dcfeff70e14a9f215824049044f67104a636e813f0fb1454d110408390986aa27355d71f8dffda1b528d7a6af33644b5d458da4d729";
        strSporkKeyOld = "04B433E6598390C992F4F022F20D3B4CBBE691652EE7C48243B81701CBDB7CC7D7BF0EE09E154E6FCBF2043D65AF4E9E97B89B5DBAF830D83B9B7F469A6C45A717";
        strObfuscationPoolDummyAddress = "9PDvFyhuDoQP7vjP96pCF5tvE68b71rQ3f";
        nStartMasternodePayments = 1566914714;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zxnk to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("04eb16cab506c320964d44a25e12f800fd73dd75e0c3c5ae416587373a00a721364b65ba407c06a6833b90bbe40a62e473bb0e1ae6b9f9a550962b709a18a5de94");
        nDefaultPort = 22044;
        ...
        strSporkKey = "0495bd5e0ae1b049052e0afc9596c9649530d6146818157c1c65d1c26ee17c0fb10f3b31fbe393c6dc9b7d5bf54063db08a66cd938de0f3a31c614c63200e87632";
        strSporkKeyOld = "04348C2F50F90267E64FACC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
        strObfuscationPoolDummyAddress = "MFUryYLWWf6V7W7hvmG4k8WMFRLm5Vvo8A";
        nStartMasternodePayments = 1566914714;
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c9e60965602f9f52ab9b2c46fc29143c05cd97f6e34bbb5185f882c303a"));
        //assert(hashGenesisBlock == uint256("0x053be0e0df5c518c881bcb33ffec422865e86fab92e40dec57837f1d517c2880"));
