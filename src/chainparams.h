...
public:
    ...
    bool IsStakeModifierV3(const int nHeight) const { return nHeight >= nBlockStakeModifierlV3; }
    virtual CAmount GetRequiredMasternodeCollateral(int nTargetHeight) const = 0;
