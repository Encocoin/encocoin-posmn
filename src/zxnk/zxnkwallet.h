...
#ifndef Encocoin_ZXNKWALLET_H
#define Encocoin_ZXNKWALLET_H
...
public:
    CzXNKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXNK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXNK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
