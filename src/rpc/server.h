...
extern UniValue DoZxnkSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzxnkseed(const UniValue& params, bool fHelp);
extern UniValue getzxnkseed(const UniValue& params, bool fHelp);
