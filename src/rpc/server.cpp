...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Encocoin features */
        {"encocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"encocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"encocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"encocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"encocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"encocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"encocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"encocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"encocoin", "startmasternode", &startmasternode, true, true, false},
        {"encocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"encocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"encocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"encocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"encocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"encocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"encocoin", "preparebudget", &preparebudget, true, true, false},
        {"encocoin", "submitbudget", &submitbudget, true, true, false},
        {"encocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"encocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"encocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"encocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"encocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"encocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"encocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"encocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"encocoin", "mnsync", &mnsync, true, true, false},
        {"encocoin", "spork", &spork, true, true, false},
        {"encocoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxnkseed", &getzxnkseed, false, false, true},
        {"zerocoin", "setzxnkseed", &setzxnkseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxnk", &searchdzxnk, false, false, true},
        {"zerocoin", "dzxnkstate", &dzxnkstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12043/\n";
}
