Contributing to Encocoin Core
============================

The Encocoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/encocoin-project/encocoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Encocoin Core project, and is not to be
confused with overall Encocoin Network Protocol consensus changes.

Whether a pull request is merged into Encocoin Core rests with the project merge
...
Patches that change Encocoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Encocoin consensus, it must have been
...
The project leader is the release manager for each Encocoin Core release.
