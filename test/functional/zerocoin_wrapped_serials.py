...
from fake_stake.base_test import Encocoin_FakeStakeTest

class zXNKwrappedSerialsTest(Encocoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zXNKs..." % DENOM_TO_USE)
